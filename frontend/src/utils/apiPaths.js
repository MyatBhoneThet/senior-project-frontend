...
export const API_PATHS = {
  ...
  DEBTS: {
    BASE: "/api/v1/debts",
    LEND: "/api/v1/debts/lend",
    BORROW: "/api/v1/debts/borrow",
    UNREAD_COUNTS: "/api/v1/debts/unread-counts",
    DETAIL: (id) => `/api/v1/debts/${id}`,
    UPDATE: (id) => `/api/v1/debts/${id}`,
    MARK_REPAID: (id) => `/api/v1/debts/${id}/mark-repaid`,
    REPAYMENTS: (id) => `/api/v1/debts/${id}/repayments`,
    REMINDERS: (id) => `/api/v1/debts/${id}/reminders`,
    OPEN_CHAT: (id) => `/api/v1/debts/${id}/chat`,
    MESSAGES: (id) => `/api/v1/debts/${id}/chat/messages`,
  },
  NOTIFICATIONS: {

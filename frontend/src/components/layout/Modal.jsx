...
const Modal = ({ isOpen, onClose, title, children, accent = 'neutral' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-slate-950/55 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-3xl max-h-full">
        <div
          className={`relative overflow-hidden rounded-[28px] border shadow-[0_30px_120px_rgba(0,0,0,0.35)] backdrop-blur-2xl ${
        ...
        >
          ...
          <div className={`relative flex items-center justify-between border-b px-5 py-4 md:px-6 md:py-5 ${
            ...
            <button
              type="button"
              className={`inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl border transition-colors ${
                isDark

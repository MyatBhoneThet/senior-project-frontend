        ...
        <div className="space-y-4">
          ...
          <div className="group">
            ...
            <div className="flex justify-center">
              <EmojiPickerPopup icon={income.icon} onSelect={handleEmojiSelect} isDark={isDarkTheme} />
            </div>
          </div>
          ...
          <div className="group">
            ...
            <input
              ...
              type="text"
              className={`w-full px-3 py-3 rounded-lg text-sm border-2 transition-all duration-200 ${isDarkTheme ? 'bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-green-500 focus:bg-gray-800/80' : 'bg-white/80 border-gray-200 text-gray-900 placeholder-gray-500 focus:border-green-500 focus:bg-white'} focus:outline-none focus:ring-2 focus:ring-green-500/20 backdrop-blur-sm`}
              required
            />
          </div>
          ...
          <div className="group">
            ...
            {/* Scoped overrides so nested inputs show clearly in dark mode */}
            <div
              className={`p-3 rounded-lg border-2 transition-all duration-200 ${
                isDarkTheme
                  ? [
                      'bg-gray-800/50 border-gray-600 backdrop-blur-sm',
                      // force nested content to white in dark mode
                      '[&_*]:text-gray-100 [&_*]:placeholder-gray-400',
                      '[&_input]:bg-gray-900/60 [&_input]:border-gray-600',
                      '[&_select]:bg-gray-900/60 [&_select]:border-gray-600',
                      '[&_textarea]:bg-gray-900/60 [&_textarea]:border-gray-600',
                      '[&_button]:text-white',
                    ].join(' ')
                  : [
                      'bg-white/80 border-gray-200 backdrop-blur-sm',
                      '[&_*]:text-gray-900 [&_*]:placeholder-gray-500',
                    ].join(' ')
              }`}
            >
              <CategorySelect
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  className={`w-full pl-8 pr-3 py-3 rounded-lg text-sm border-2 transition-all duration-200 ${isDarkTheme ? 'bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-green-500 focus:bg-gray-800/80' : 'bg-white/80 border-gray-200 text-gray-900 placeholder-gray-500 focus:border-green-500 focus:bg-white'} focus:outline-none focus:ring-2 focus:ring-green-500/20 backdrop-blur-sm`}
                  required
                />
              </div>
            </div>
            ...
            <div className="group">
              ...
              <input
                ...
                type="date"
                className={`w-full px-3 py-3 rounded-lg text-sm border-2 transition-all duration-200 ${isDarkTheme ? 'bg-gray-800/50 border-gray-600 text-white focus:border-green-500 focus:bg-gray-800/80' : 'bg-white/80 border-gray-200 text-gray-900 focus:border-green-500 focus:bg-white'} focus:outline-none focus:ring-2 focus:ring-green-500/20 backdrop-blur-sm`}
                required
              />
            </div>
          </div>
